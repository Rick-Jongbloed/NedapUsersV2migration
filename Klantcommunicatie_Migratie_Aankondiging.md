...
In het kader van de migratie van onze Nedap Ons-koppeling naar de nieuwe versie plannen we de volgende werkzaamheden in:
...
**Testomgeving — [datum]**  
Op [datum] voeren we de migratie uit op jullie testomgeving. We vragen je om vóór [datum, uiterlijk de dag ervoor] een verse kopie van de productieomgeving naar de testomgeving te zetten, zodat we met actuele data kunnen werken.
